...
```dotenv
APPLE_CONTAINER_SUB2API_IMAGE=ghcr.io/chanbomaydii/trumcheatapi:latest
...
SUB2API_IMAGE=ghcr.io/chanbomaydii/trumcheatapi:latest # Match APPLE_CONTAINER_SUB2API_IMAGE in .env.
