...
func APIKeyFromService(k *service.APIKey) *APIKey {
	...
	out := &APIKey{
		...
		TokenUnitPrice:     k.TokenUnitPrice,
		TokenDurationDays:  k.TokenDurationDays,
		TokenPurchasePrice: k.TokenPurchasePrice,
		TokenPurchasedAt:   k.TokenPurchasedAt,
...
func RedeemCodeFromServiceAdmin(rc *service.RedeemCode) *AdminRedeemCode {
	...
	return &AdminRedeemCode{
		...
		Notes:               rc.Notes,
		Source:              rc.Source,
		CreatedByResellerID: rc.CreatedByResellerID,
	}
}
