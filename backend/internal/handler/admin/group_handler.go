...
type CreateGroupRequest struct {
	...
	SubscriptionType           string                        `json:"subscription_type" binding:"omitempty,oneof=standard subscription token"`
	TokenLimit                 int64                         `json:"token_limit" binding:"omitempty,min=0"`
	TokenPricePerMillionPerDay float64                       `json:"token_price_per_million_per_day" binding:"omitempty,min=0"`
...
func (h *GroupHandler) Create(c *gin.Context) {
	...
	group, err := h.adminService.CreateGroup(c.Request.Context(), &service.CreateGroupInput{
		...
		TokenPricePerMillionPerDay:      req.TokenPricePerMillionPerDay,
