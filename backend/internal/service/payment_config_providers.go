...
var providerSensitiveConfigFields = map[string]map[string]struct{}{
	...
	payment.TypeRpayMBBank: {"password": {}, "token": {}},
	payment.TypeRpayUSDT:   {"apikey": {}},
}
...
var providerPendingOrderProtectedConfigFields = map[string]map[string]struct{}{
	...
	payment.TypeRpayMBBank: {"password": {}, "token": {}, "accountnumber": {}, "apibase": {}, "vndperusdt": {}},
	payment.TypeRpayUSDT:   {"merchantid": {}, "apikey": {}, "network": {}, "token": {}, "apibase": {}, "callbackurl": {}},
}
...
var validProviderKeys = map[string]bool{
	...
	payment.TypeRpayMBBank: true,
	payment.TypeRpayUSDT:   true,
}
