...
func init() {
	...
	// apikeyDescTokenQuota is the schema descriptor for token_quota field.
	apikeyDescTokenQuota := apikeyFields[10].Descriptor()
	// apikey.DefaultTokenQuota holds the default value on creation for the token_quota field.
	apikey.DefaultTokenQuota = apikeyDescTokenQuota.Default.(int64)
	// apikey.TokenQuotaValidator is a validator for the "token_quota" field. It is called by the builders before save.
	apikey.TokenQuotaValidator = apikeyDescTokenQuota.Validators[0].(func(int64) error)
	// apikeyDescTokenUsed is the schema descriptor for token_used field.
	apikeyDescTokenUsed := apikeyFields[11].Descriptor()
	// apikey.DefaultTokenUsed holds the default value on creation for the token_used field.
	apikey.DefaultTokenUsed = apikeyDescTokenUsed.Default.(int64)
	// apikey.TokenUsedValidator is a validator for the "token_used" field. It is called by the builders before save.
	apikey.TokenUsedValidator = apikeyDescTokenUsed.Validators[0].(func(int64) error)
	// apikeyDescTokenUnitPrice is the schema descriptor for token_unit_price field.
	apikeyDescTokenUnitPrice := apikeyFields[12].Descriptor()
	// apikey.DefaultTokenUnitPrice holds the default value on creation for the token_unit_price field.
	apikey.DefaultTokenUnitPrice = apikeyDescTokenUnitPrice.Default.(float64)
	// apikey.TokenUnitPriceValidator is a validator for the "token_unit_price" field. It is called by the builders before save.
	apikey.TokenUnitPriceValidator = apikeyDescTokenUnitPrice.Validators[0].(func(float64) error)
	// apikeyDescTokenDurationDays is the schema descriptor for token_duration_days field.
	apikeyDescTokenDurationDays := apikeyFields[13].Descriptor()
	// apikey.DefaultTokenDurationDays holds the default value on creation for the token_duration_days field.
	apikey.DefaultTokenDurationDays = apikeyDescTokenDurationDays.Default.(int)
	// apikey.TokenDurationDaysValidator is a validator for the "token_duration_days" field. It is called by the builders before save.
	apikey.TokenDurationDaysValidator = apikeyDescTokenDurationDays.Validators[0].(func(int) error)
	// apikeyDescTokenPurchasePrice is the schema descriptor for token_purchase_price field.
	apikeyDescTokenPurchasePrice := apikeyFields[14].Descriptor()
	// apikey.DefaultTokenPurchasePrice holds the default value on creation for the token_purchase_price field.
	apikey.DefaultTokenPurchasePrice = apikeyDescTokenPurchasePrice.Default.(float64)
	// apikey.TokenPurchasePriceValidator is a validator for the "token_purchase_price" field. It is called by the builders before save.
	apikey.TokenPurchasePriceValidator = apikeyDescTokenPurchasePrice.Validators[0].(func(float64) error)
	...
	// groupDescTokenLimit is the schema descriptor for token_limit field.
	groupDescTokenLimit := groupFields[12].Descriptor()
	// group.DefaultTokenLimit holds the default value on creation for the token_limit field.
	group.DefaultTokenLimit = groupDescTokenLimit.Default.(int64)
	// group.TokenLimitValidator is a validator for the "token_limit" field. It is called by the builders before save.
	group.TokenLimitValidator = groupDescTokenLimit.Validators[0].(func(int64) error)
	// groupDescTokenPricePerMillionPerDay is the schema descriptor for token_price_per_million_per_day field.
	groupDescTokenPricePerMillionPerDay := groupFields[13].Descriptor()
	// group.DefaultTokenPricePerMillionPerDay holds the default value on creation for the token_price_per_million_per_day field.
	group.DefaultTokenPricePerMillionPerDay = groupDescTokenPricePerMillionPerDay.Default.(float64)
	// group.TokenPricePerMillionPerDayValidator is a validator for the "token_price_per_million_per_day" field. It is called by the builders before save.
	group.TokenPricePerMillionPerDayValidator = groupDescTokenPricePerMillionPerDay.Validators[0].(func(float64) error)
