...
type UserEdges struct {
	...
	// CreatedResellerRedeemCodes holds the value of the created_reseller_redeem_codes edge.
	CreatedResellerRedeemCodes []*RedeemCode `json:"created_reseller_redeem_codes,omitempty"`
...
// CreatedResellerRedeemCodesOrErr returns the CreatedResellerRedeemCodes value or an error if the edge
// was not loaded in eager-loading.
func (e UserEdges) CreatedResellerRedeemCodesOrErr() ([]*RedeemCode, error) {
	if e.loadedTypes[2] {
		return e.CreatedResellerRedeemCodes, nil
	}
	return nil, &NotLoadedError{edge: "created_reseller_redeem_codes"}
}
...
// QueryCreatedResellerRedeemCodes queries the "created_reseller_redeem_codes" edge of the User entity.
func (_m *User) QueryCreatedResellerRedeemCodes() *RedeemCodeQuery {
	return NewUserClient(_m.config).QueryCreatedResellerRedeemCodes(_m)
}
