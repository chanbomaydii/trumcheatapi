...
export async function create(
  ...
  tokenPurchase?: { token_amount: number; duration_days: number }
): Promise<ApiKey> {
  ...
  if (tokenPurchase) {
    payload.token_amount = tokenPurchase.token_amount
    payload.duration_days = tokenPurchase.duration_days
  }
