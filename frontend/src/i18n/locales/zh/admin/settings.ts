export default {
    settings: {
      ...
      features: {
        ...
        affiliate: {
          title: '推广',
          description: '用户邀请新用户注册，并在被邀请用户充值后获得推广奖励。默认关闭。',
          enabled: '启用推广',
          enabledHint: '关闭后推广入口隐藏、注册时忽略推广码、新充值不再产生奖励。已有奖励仍可结算到余额。',
          adminRechargeRebate: '管理员充值参与奖励',
          adminRechargeRebateHint: '开启后，通过“用户管理 > 充值”增加的余额会产生推广奖励；设置余额和扣款不参与。',
          rebateRate: '全局奖励比例',
          rebateRateHint: '邀请人从充值中获得的默认奖励比例（0-100%，例如填写 10 表示 10%）。',
          freezeHours: '奖励冻结期（小时）',
          freezeHoursDesc: '新产生的奖励在此期间不可结算。0 = 不冻结。',
          durationDays: '奖励有效期（天）',
          durationDaysDesc: '被邀请用户注册后多少天内的充值产生奖励。0 = 永久有效。',
          perInviteeCap: '单人奖励上限',
          perInviteeCapDesc: '每个被邀请用户最多产生的奖励总额。0 = 无上限。',
          customUsers: {
            title: '专属用户配置',
            description: '为指定用户设置专属推广码或奖励比例。仅展示已设置过专属配置的用户。',
            addButton: '添加专属用户',
    ...
    field_password: 'MBBank 登录密码',
    field_accountNumber: 'MBBank 账户号码',
    field_accountName: '账户名称',
    field_token: 'Rpay API Token',
    field_vndPerUsdt: '每 USDT 对应 VND',
    field_merchantId: 'Rpay 商户 ID',
    field_network: '区块链网络',
    field_expireMinutes: '订单有效期（分钟）',
