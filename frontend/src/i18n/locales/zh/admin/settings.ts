export default {
    ...
    field_password: 'MBBank τÖ╗σ╜òσ»åτáü',
    field_accountNumber: 'MBBank Φ┤ªµê╖σÅ╖τáü',
    field_accountName: 'Φ┤ªµê╖σÉìτº░',
    field_token: 'Rpay API Token',
    field_vndPerUsdt: 'µ»Å USDT σ»╣σ║ö VND',
    field_merchantId: 'Rpay σòåµê╖ ID',
    field_network: 'σî║σ¥ùΘô╛τ╜æτ╗£',
    field_expireMinutes: 'Φ«óσìòµ£ëµòêµ£ƒ∩╝êσêåΘÆƒ∩╝ë',
