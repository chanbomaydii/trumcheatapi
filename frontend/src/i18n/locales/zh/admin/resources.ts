export default {
    ...
    redeem: {
      title: 'CDKey管理',
      description: '创建和管理CDKey',
      generateCodes: '创建CDKey',
      columns: {
        code: 'CDKey',
        type: '类型',
        value: '面值',
      ...
      unused: '未使用',
      used: '已使用',
      searchCodes: '搜索CDKey或用户邮箱...',
      exportCsv: '导出 CSV',
      batchUpdate: '批量修改',
      batchUpdateTitle: '批量修改CDKey',
      selectedCount: '已选择 {count} 个CDKey',
      clearSelection: '清空选择',
      selectCodesFirst: '请先选择CDKey',
      noBatchFieldsSelected: '请至少勾选一个要修改的字段',
      batchUpdateSuccess: '成功修改 {count} 个CDKey',
      failedToBatchUpdate: '批量修改CDKey失败',
      batchFields: {
        status: '状态',
        expiresAt: '过期时间',
        notes: '备注',
      ...
      deleteCodeConfirm: '确定要删除此CDKey吗？此操作无法撤销。',
      deleteAllUnusedConfirm: '确定要删除当前来源下全部未使用的CDKey吗？此操作无法撤销。',
      deleteAll: '全部删除',
      generateCodesTitle: '创建CDKey',
      generatedSuccessfully: '生成成功',
      codesCreated: '已创建 {count} 个CDKey',
      codeType: '类型',
      amount: '金额 ($)',
      value: '面值',
      count: '数量',
      ...
      copyAll: '全部复制',
      download: '下载',
      codesExported: 'CDKey导出成功',
      codeDeleted: 'CDKey删除成功',
      codesDeleted: '成功删除 {count} 个未使用的CDKey',
      noUnusedCodes: '没有未使用的CDKey可删除',
      userPrefix: '用户 #{id}',
      failedToExport: '导出CDKey失败',
      failedToDeleteUnused: '删除未使用的CDKey失败',
      failedToCopy: '复制失败',
      selectGroup: '选择分组',
