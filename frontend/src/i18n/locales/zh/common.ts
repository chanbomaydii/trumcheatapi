export default {
  ...
  nav: {
    ...
    affiliate: '推广',
    affiliateManagement: '推广',
    affiliateInviteRecords: '邀请记录',
    affiliateRebateRecords: '奖励记录',
    affiliateTransferRecords: '结算记录',
    profile: '个人资料',
    users: '用户管理',
    groups: '分组管理',
    channels: '渠道管理',
  ...
  codes: {
    title: 'CDKey管理',
    description: '创建、分发、追踪和停用CDKey。',
    createCDKeys: '创建CDKey',
    create: '创建',
    sources: {
      all: '全部来源',
      system: '系统',
    ...
    resellerOwner: '经销商',
    reseller: '经销商',
    createForReseller: '为经销商创建',
    selectReseller: '选择经销商',
    totalDebit: '扣款总额',
    balance: '余额',
    failedToLoadResellers: '加载经销商失败',
  },
  ...
  auth: {
    ...
    invitationCodeUnifiedHint: '支持一次性邀请码或经销商邀请码。',
