export default {
  ...
  nav: {
    ...
    affiliate: 'Affiliate',
    affiliateManagement: 'Affiliate',
    affiliateInviteRecords: 'Invite Records',
    affiliateRebateRecords: 'Commission Records',
    affiliateTransferRecords: 'Payout Records',
    profile: 'Profile',
    users: 'Users',
    groups: 'Groups',
    channels: 'Channels',
    ...
    resellerUsers: 'Managed Users',
    cdkeys: 'CDKeys',
  },

  codes: {
    title: 'CDKeys',
    description: 'Create, distribute, track, and revoke access keys.',
    createCDKeys: 'Create CDKeys',
    create: 'Create',
    sources: {
      all: 'All sources',
      system: 'System',
    ...
    reseller: 'Reseller',
    createForReseller: 'Create for Reseller',
    selectReseller: 'Select a reseller',
    totalDebit: 'Total debit',
    balance: 'Balance',
    failedToLoadResellers: 'Failed to load resellers',
  },
  ...
  auth: {
    ...
    invitationCodeUnifiedHint: 'Accepts a one-time invitation code or a reseller code.',
