export default {
    ...
    // Redeem Codes
    redeem: {
      title: 'CDKey Management',
      description: 'Create and manage CDKeys',
      generateCodes: 'Create CDKeys',
      searchCodes: 'Search CDKeys or user email...',
      allTypes: 'All Types',
      allStatus: 'All Status',
      balance: 'Balance',
      ...
      batchUpdateTitle: 'Batch Update CDKeys',
      selectedCount: '{count} CDKey(s) selected',
      clearSelection: 'Clear selection',
      selectCodesFirst: 'Select CDKeys first',
      noBatchFieldsSelected: 'Select at least one field to update',
      batchUpdateSuccess: 'Updated {count} CDKey(s)',
      failedToBatchUpdate: 'Failed to batch update CDKeys',
      batchFields: {
        status: 'Status',
        expiresAt: 'Expires At',
        notes: 'Notes',
      ...
      deleteCode: 'Delete CDKey',
      deleteCodeConfirm:
        'Are you sure you want to delete this CDKey? This action cannot be undone.',
      deleteAllUnusedConfirm:
        'Are you sure you want to delete all unused CDKeys from this source? This action cannot be undone.',
      deleteAll: 'Delete All',
      generateCodesTitle: 'Create CDKeys',
      generatedSuccessfully: 'Generated Successfully',
      codesCreated: '{count} CDKey(s) created',
      codeType: 'Code Type',
      amount: 'Amount ($)',
      value: 'Value',
      count: 'Count',
