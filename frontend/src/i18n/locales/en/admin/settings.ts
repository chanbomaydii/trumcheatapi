export default {
    settings: {
      ...
      features: {
        ...
        affiliate: {
          title: 'Affiliate',
          description: 'Existing users invite new ones and earn commission when invitees recharge. Disabled by default.',
          enabled: 'Enable Affiliate',
          enabledHint: 'When off, the Affiliate menu is hidden, referral parameters are ignored at signup, and new recharges generate no commission. Existing rewards can still be paid out.',
          adminRechargeRebate: 'Commission on Admin Deposits',
          adminRechargeRebateHint: 'When enabled, balance added through User Management > Deposit generates affiliate commission. Setting a balance or withdrawing funds does not.',
          rebateRate: 'Global Commission Rate',
          rebateRateHint: 'Default commission percentage earned by the inviter on recharges (0-100, e.g. 10 = 10%).',
          freezeHours: 'Commission Hold Period (hours)',
          freezeHoursDesc: 'New commission is held for this period before becoming available. 0 = no hold.',
          durationDays: 'Commission Duration (days)',
          durationDaysDesc: 'The commission relationship expires after this many days since invitee registration. 0 = permanent.',
          perInviteeCap: 'Per-Invitee Commission Cap',
          perInviteeCapDesc: 'Maximum total commission from a single invitee. 0 = no limit.',
          customUsers: {
            title: 'Per-User Overrides',
            description: 'Set a custom invite code or commission rate for specific users. Lists only users that have an override applied.',
      ...
      payment: {
        ...
        providerRpayMbbank: 'Rpay MBBank',
        providerRpayUsdt: 'Rpay USDT',
    ...
    field_password: 'MBBank login password',
    field_accountNumber: 'MBBank account number',
    field_accountName: 'Account holder name',
    field_token: 'Rpay API token',
    field_vndPerUsdt: 'VND per USDT',
    field_merchantId: 'Rpay Merchant ID',
    field_network: 'Blockchain network',
    field_expireMinutes: 'Invoice expiry (minutes)',
