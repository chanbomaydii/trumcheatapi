export default {
    ...
    groups: {
      ...
      subscription: {
        ...
        type: 'Billing Type',
        typeHint:
          'Standard deducts balance, Subscription uses periodic USD quotas, and Token deducts balance while limiting each key by tokens.',
        typeNotEditable: 'Billing type cannot be changed after group creation.',
        standard: 'Standard (Balance)',
        subscription: 'Subscription (Quota)',
        token: 'Prepaid Token',
        tokenLimit: 'Token limit per key',
        tokenLimitHint: 'Each new key receives this token quota and still deducts USD from the user balance.',
